...
=== "macOS (Apple Silicon)"
    ...
    ```bash
    curl -LO https://github.com/Traitome/oxo-flow/releases/download/v0.12.0/oxo-flow-v0.12.0-aarch64-apple-darwin.tar.gz
    tar xzf oxo-flow-v0.12.0-aarch64-apple-darwin.tar.gz
    chmod +x oxo-flow
