...
=== "Linux (x86_64)"
    ...
    ```bash
    curl -LO https://github.com/Traitome/oxo-flow/releases/download/v0.14.0/oxo-flow-v0.14.0-x86_64-unknown-linux-gnu.tar.gz
    tar xzf oxo-flow-v0.14.0-x86_64-unknown-linux-gnu.tar.gz
    chmod +x oxo-flow
...
=== "macOS (Apple Silicon)"
    ...
    ```bash
    curl -LO https://github.com/Traitome/oxo-flow/releases/download/v0.14.0/oxo-flow-v0.14.0-aarch64-apple-darwin.tar.gz
    tar xzf oxo-flow-v0.14.0-aarch64-apple-darwin.tar.gz
    chmod +x oxo-flow
...
```bash
curl -LO https://github.com/Traitome/oxo-flow/releases/download/v0.14.0/SHA256SUMS.txt
