...
=== "Linux (x86_64)"
    ...
    ```bash
    curl -LO https://github.com/Traitome/oxo-flow/releases/download/v0.18.1/oxo-flow-v0.18.1-x86_64-unknown-linux-gnu.tar.gz
    tar xzf oxo-flow-v0.18.1-x86_64-unknown-linux-gnu.tar.gz
    chmod +x oxo-flow
...
=== "macOS (Apple Silicon)"
    ...
    ```bash
    curl -LO https://github.com/Traitome/oxo-flow/releases/download/v0.18.1/oxo-flow-v0.18.1-aarch64-apple-darwin.tar.gz
    tar xzf oxo-flow-v0.18.1-aarch64-apple-darwin.tar.gz
    chmod +x oxo-flow
...
```bash
curl -LO https://github.com/Traitome/oxo-flow/releases/download/v0.18.1/SHA256SUMS.txt
...
docker run -d -p 3000:3000 ghcr.io/traitome/oxo-flow:0.18.1
