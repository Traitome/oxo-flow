...
// ---------------------------------------------------------------------------
// Audit persistence (storage backend for the audit middleware — issue #79
// P1-05). Everything else lives in `infra::db`.
// ---------------------------------------------------------------------------

/// Insert one audit record with explicit result + metadata.
