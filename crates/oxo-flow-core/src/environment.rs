...
mod tests {
    ...
    fn mirrored_spec_rewrites_docker_uri_hosts() {
        let mirrors = Some("docker.io=m.example.com;registry-1.docker.io=m.example.com;ghcr.io=m-ghcr.example.com;quay.io=m-quay.example.com");
        assert_eq!(
