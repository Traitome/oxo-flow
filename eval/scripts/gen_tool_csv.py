...
def curated_purpose_queries():
    ...
    return [
        ...
        ("single-cell RNA-seq clustering and UMAP in R", "r-seurat"),
        ("16S amplicon sequence variant inference in R", "bioconductor-dada2"),
        ("functional variant annotation with SnpEff", "snpeff"),
